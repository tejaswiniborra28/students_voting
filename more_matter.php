...
<body>
	...
	<p style="margin:15px 180px 0px 12px">
		...
		vote consolidation and tabulation, and election administration. <br>A worthy e-voting system must perform most of these tasks while complying 
		...
		remote e-voting via the internet (also called i-voting) where the voter votes at home or without going to a polling station.<br>
		...
		reported of machines making unpredictable, inconsistent errors. <br>Key issues with electronic voting are therefore the openness of a system 
